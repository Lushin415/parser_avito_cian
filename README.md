...
📚 **Документация для разработчиков** — [смотреть](DOCS.md)
...
В случае использования podman-compose рекомендуется устаналивать его из ветки main (см. https://github.com/containers/podman-compose/issues/1275)
